...
<div class="pop-up-screen">
	 <div class="pop-up-content">
		<h3>Thank you...</h3>
		<p>for downloading this plugin. Simple Signup Form Free is a limited version, even you can reach many of options. If you really would like to get much more customization possibilities, purchase the <a target="_blank" href="http://simplesignupform.pantherius.com/">PRO version</a> for only a one-time fee: $18</p>
...
<img src="'.plugins_url( '/assets/img/fivestar.jpg' , __FILE__ ).'"/>
		...
		<ul>
			...
			<li>- Custom Radio Buttons, Select Field, Textarea, Hidden Field, Video or Image Background</li>
