...
class CF7_cloud_loader extends CF7_cloud_interface {
    ...
    private $cf7_cloud_db_version = '1.3.12'; // cf7 cloud current DB version.
    private $cf7_cloud_version = '1.3.12';
        ...
        <div class="mail-field">
            ...
            <div id="cf7cloud-formdata" <?php echo ($is_active_form) ? 'style="display:block"' : ""; ?>>
                ...
                <div id="cf7cloud_video">
                    ...
                    <iframe src="//www.youtube.com/embed/e7Uub6SDzNc" width="356" height="195" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                ...
                <table class="cf7cloud_custom_fields_table" <?php echo ($is_active_form) ? 'style="display:block"' : 'style="display:none"'; ?>>
                    ...
                    $cus_CRED_url = $cus_par_url . '/index.php?loginName='.$CF7i_API_Account.'&userPsswd='.urlencode($CF7i_API_Key);
                    ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="3"><strong>What’s Next?</strong>
                                ...
                                <ul>	
                                    <li><a href="<?php echo $cus_CRED_url; ?>&confirmed=1" target="_blank" rel="toDash" class="deep_link_action">View Your Stats</a></li>
                                </ul>			
                            </td>
                        </tr>
                    </tbody>
    ...
    public function wpcf7_cloud_send_all($wpcf7) {
        ...
        if ($cf7cloud_data && is_array($cf7cloud_data) && $is_active) {
            ...
            curl_setopt($ch, CURLOPT_HTTPHEADER, array(
                ...
                'X-ContactUs-Signature: CF7i|1.3.12|' . $cuapi->getIP(),
            ));
